<expectations>
    ...
    <script>
        ...
        self.questions = ["Red will move, then Blue will move, then Pink will move", "Red will move, then Pink will move, then Blue will move", "Red will move, then Blue and Pink will move at the same time"];
        ...
        self.results = function () {
            ...
            if (answer === self.answers[2]) {
                verdict = "nonsensical";
            } else if ((answer === self.answers[0] && !self.extraObjs) || (answer === self.answers[1] && self.extraObjs)) {
                verdict = "congruent";
            } else {
                verdict = "incongruent"
            }
